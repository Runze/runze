...
Recently, upon various trials and errors, I have finally implemented the same model in Keras ([GitHub](https://github.com/Runze/seq2seq-translation-attention)), largely thanks to the deep learning [course](https://www.coursera.org/specializations/deep-learning#courses) offered by Andrew Ng on Coursera (especially the one on sequence models) and, obviously, Stack Overflow. 🙏
